                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block user-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item d-block" href="{{ route('viewChangePass') }}"><i
            ...
            <div data-simplebar class="h-100">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="{{ route('logGame') }}" class="waves-effect">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{ route('walletSettings') }}">Wallet Setting</a></li>
                                <li><a href="{{ route('setting') }}">Apps Setting</a></li>
                            </ul>
                        </li>
